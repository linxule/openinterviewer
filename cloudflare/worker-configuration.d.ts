/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false cloudflare/worker-configuration.d.ts` (hash: 5fa4f64c529527a13f38a06992d747a3)
// Runtime types generated with workerd@1.20260921.1 2026-09-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	WORKSPACE_STORE: DurableObjectNamespace<import("./worker").WorkspaceStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "WorkspaceStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_TARGET" | "DEPLOYMENT_MODE" | "AI_TRANSPORT" | "AI_PROVIDER" | "CF_AI_GATEWAY_ACCOUNT_ID" | "CF_AI_GATEWAY_ID" | "APP_BASE_URL" | "WORKSPACE_ID" | "WORKSPACE_JURISDICTION" | "WORKSPACE_BOOTSTRAP">> {}
}
