...
> **Status (2026-09-05):** Owner retired the A9 moderated-test gate as an unnecessary blocker — the direction ships on its own judgement; the written participant-layout fallback stays on record as the response to real feedback. Third train planned in `docs/design/initiative-3-brief.md`; margin unfold (A7's desktop placement) struck for that train.
